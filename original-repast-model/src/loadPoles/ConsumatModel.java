...
public class ConsumatModel {
	...
	private double calcVehicleSatisfaction(Vehicle vehicle) {
		...
		double productSatisfaction = findProductSatisfaction(vehicle);
	...
	private double findProductSatisfaction(Vehicle product) {
		//TODO: find difference between vehicle characteristics and personal preferences
		return 1;
	}	
}
